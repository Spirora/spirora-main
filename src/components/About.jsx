    ...
    <section id="about" className="py-24 relative z-10 w-full">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-white via-slate-50 to-brand-primary/10 z-0"/>
          ...
          <motion.div
            ...
            className="relative z-20 w-48 h-32 glass bg-white/60 border-white/40 rounded-xl shadow-2xl backdrop-blur-md -ml-20 -mt-10"
          >
            <div className="p-4 space-y-2">
              <div className="h-2 w-1/2 bg-brand-accent/50 rounded-full" />
              <div className="h-2 w-5/6 bg-slate-300 rounded-full" />
              <div className="h-2 w-4/6 bg-slate-300 rounded-full" />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative z-30 w-56 h-40 glass bg-white/60 border-white/40 rounded-xl shadow-[0_4px_30px_rgba(79,70,229,0.1)] backdrop-blur-lg ml-10 mt-20 flex flex-col justify-end p-4"
          >
