    ...
    <section className="py-24 relative z-10 w-full overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 text-center relative z-20">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand-purple/20 rounded-full blur-[80px]" />
          
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-white mb-6 relative z-10">
            Ready to <span className="text-glow text-brand-primary">Scale?</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            <button className="px-10 py-4 rounded-full bg-brand-primary text-white font-bold text-lg hover:scale-105 transition-transform shadow-[0_0_30px_rgba(79,70,229,0.5)] hover:shadow-[0_0_50px_rgba(79,70,229,0.7)] border border-brand-primary/50">
              Start a Project
            </button>
          </div>
        </motion.div>
